...
/**
 * Instances of this class are used to configure {@link io.netty.channel.epoll.EpollIoHandler} instances.
 * @author <a href="mailto:dreamlike.vert@gmail.com">dreamlikeOcean</a>
 */
public class EpollTransportConfig implements TransportConfig {
   ...
   */
  public EpollTransportConfig setMaxEvents(int maxEvents) {
    if (maxEvents < 0) {
